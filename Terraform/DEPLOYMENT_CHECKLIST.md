...
> **📖 詳細な説明**: 各手順の背景や詳細な解説は [SETUP_GUIDE.md](./SETUP_GUIDE.md) を参照してください。
>
> - **このドキュメント**: チェックリスト形式で抜け漏れなく作業を進める（2回目以降の運用に最適）
> - **SETUP_GUIDE.md**: 各手順の「なぜ」を理解しながら進める（初回セットアップや学習に最適）
...
> **詳細**: S3バケットの役割分担や背景については [SETUP_GUIDE.md - 事前準備](./SETUP_GUIDE.md#4-事前準備重要) を参照してください。
...
- [ ] **Azure Resource Providerの登録**（初回のみ、重要）
  ...
  > **詳細**: Resource Provider登録の背景については [SETUP_GUIDE.md - Azure Resource Providerの登録](./SETUP_GUIDE.md#3-1-azure-resource-providerの登録初回のみ) を参照してください。
